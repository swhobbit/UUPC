...
/*
 *    $Id: configur.c 1.96 2001/04/20 13:35:13 ahd v1-13k $
 *
 *    Revision history:
 *    $Log: configur.c $
 *    Revision 1.96  2001/04/20 13:35:13  ahd
 *    Correct firstgrade keyword to lower case
 *
...
RCSID("$Id: configur.c 1.96 2001/04/20 13:35:13 ahd v1-13k $");
